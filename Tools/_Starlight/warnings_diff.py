...
def __main__():
    ...
    #convert to string
    if only_in_dev:
        diff_output += "Warnings only in master build:\n"
        for line in only_in_dev:
            diff_output += line + "\n"

    if diff_output:
        print("Differences found between stable and master builds:")
        print(diff_output)
        #output to a file
        ...
        print("No differences found between stable and master builds.")
