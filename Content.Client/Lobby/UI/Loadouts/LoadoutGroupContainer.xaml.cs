...
public sealed partial class LoadoutGroupContainer : BoxContainer
{
    ...
    public event Action<ProtoId<LoadoutPrototype>>? OnRequestLoadoutMetadataEdit; // Floof
    ...
    private LoadoutContainer CreateLoadoutUI(LoadoutPrototype proto, HumanoidCharacterProfile profile, RoleLoadout loadout, ICommonSession session, IDependencyCollection collection, LoadoutSystem loadoutSystem)
    {
        ...
        // Show custom name + color on the preview if set
        ...
        cont.Text = loadoutPrefs?.NameOverride ?? loadoutSystem.GetName(proto);
        LoadoutMetadataEditorDialog.ColorEntity(
            cont.SpriteEntity,
            loadoutPrefs?.ColorOverride,
        ...
        // Pencil: only when this loadout is selected
